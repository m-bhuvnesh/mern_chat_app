...
const ProfilePage = () => {
  ...
  return (
    ...
    >
      ...
      border-2 border-gray-600 flex items-center justify-between max-sm:flex-col-reverse rounded-lg"
      >
        <form
          action=""
        ...
        <img
          ...
          className={`max-w-38 aspect-square 
          rounded-full mx-10 max-sm:mt-10 ${selectedImg && "rounded-full"}`}
          alt=""
        />
      </div>
    </div>
